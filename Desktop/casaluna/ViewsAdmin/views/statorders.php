...
$connect = mysqli_connect("localhost", "root", "", "ghassen");  
 $query = "SELECT pid, count(*) as number FROM orderitems GROUP BY pid";  
        ...
        <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["pid"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: 'Le produit le plus vendu ',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
...
<div id='cssmenu'>
<ul>
   <li ><a >Statistiques Commandes </a></li>
...
<div>
                <div>
                   <div id="piechart" style="width: 1000px; height: 600px;" >
                   </div>
                </div>  
                <div>
<div>
