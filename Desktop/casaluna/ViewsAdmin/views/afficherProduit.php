      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="afficherclient.php">client</a></li>
...
<ul>
   ...
   <li class='active'><a href='afficherProduit.php'>Affichage</a></li>
   <li><a href='afficherprodui.php'>Trier</a></li>
   <li><a href='pdfb/index.php'>Recherche</a></li>
...
foreach($listeProduits as $row){
  ...
  $rep="../img/Produit/"
	...
	<td><?PHP echo $row['leb_cat']; ?></td>
	<td><?PHP echo $row['prix']; ?></td>
  <td><?PHP echo $row['qte_prod']; ?></td>
  <td><img src="<?PHP echo $rep.$image; ?>" style="width: 300px;">  </td>
