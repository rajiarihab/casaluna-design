...
<ul>
   <li class='active'><a href='../buttons.html'>Ajout</a></li>
...
if (isset($_POST['modifier'])){
	$produit=new Produit($_POST['idp'],$_POST['lib_prod'],$_POST['id'],$_POST['prix'],$_POST['qte_prod'],$_POST['image'],$_POST['description']);
