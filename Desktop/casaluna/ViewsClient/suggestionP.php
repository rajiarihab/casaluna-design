...
include"../config.php";
$suggestionPC1=new suggestionPC();
$listesuggestionP=$suggestionPC1->afficherSuggestionPs();
$listesuggestionPClient=$suggestionPC1->afficherSuggestionPsClient($_SESSION['l']);
//var_dump($listeEmployes->fetchAll());
?>		
           <?PHP
foreach($listesuggestionPClient as $row1){
	?>
          <form method="POST" action="supprimerSuggestionP.php" style="border: none">
            <input type="submit" name="supprimer" value="supprimer votre suggestion" class="btn btn-primary" >
	<input type="hidden" value="<?PHP echo $row1['num']; ?>" name="num">
              <a href="modifierSuggestionP.php?num=<?PHP echo $row1['num']; ?>" class="btn btn-primary">Modifier votre suggestion </a>
              </form>
        <?php } ?>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-12 col-md-offset-0 text-center fh5co-heading">
					<h2><span>Les Suggestions</span></h2>
				</div>
			</div>
		</div>
...
<div class="row">
    <?PHP
foreach($listesuggestionP as $row){
	?>

  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h2 class="card-title">Client:<?PHP echo $row['idUtilisateur']; ?></h2>
