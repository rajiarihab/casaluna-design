...
if (isset($_GET['numReclamation'])){
    ...
    $result=$reclamationC->recupererReclamation($_GET['numReclamation']);
	foreach($result as $row){
		$numReclamation=$row['numReclamation'];
		$idUtilisateurr=$row['idUtilisateurr'];
		$sujetReclamation=$row['sujetReclamation'];
		$commentaireReclamation=$row['commentaireReclamation'];
		$date=$row['date'];
...
<td><input type="number" name="numReclamation" value="<?PHP echo $numReclamation ?>" hidden></td>
</tr>
<tr>

<td><input type="number" name="idUtilisateurr" value="<?PHP echo $idUtilisateurr ?>" hidden></td>
</tr>
<tr>
<td>sujetReclamation</td>
<td><input type="text" name="sujetReclamation" value="<?PHP echo $sujetReclamation ?>" ></td>
</tr>
<tr>
<td>commentaireReclamation</td>
<td><input type="text" name="commentaireReclamation" value="<?PHP echo $commentaireReclamation ?>"></td>
</tr>
<tr>
...
<td><input type="submit" name="modifier" value="modifier" class="btn btn-primary">
<td><a href="reclamation.php" class="btn btn-primary">Afficher</a></td>
</tr>
<tr>
<td></td>
<td><input type="hidden" name="numReclamation_ini" value="<?PHP echo $_GET['numReclamation'];?>"></td>
</tr>
</table>
</form>
...
if (isset($_POST['modifier'])){
	$reclamation=new reclamation($_POST['numReclamation'],$_SESSION['l'],$_POST['sujetReclamation'],$_POST['commentaireReclamation'],$_POST['date']);
	$reclamationC->modifierReclamation($reclamation,$_POST['numReclamation_ini']);
