...
foreach($listelivreurs as $row){
	...
	<td><?PHP echo $row['numass']; ?></td>
	<td><?PHP echo $row['num']; ?></td>
	<td><?PHP echo $row['numurg']; ?></td>
	<td><?PHP echo $row['mail']; ?></td>
	<td><?PHP echo $row['secteur']; ?></td>
	<td><?PHP echo $row['disponibilite']; ?></td>
	<td><?PHP echo $row['nombrelivraison']; ?></td>
	...
	<td><a href="modifierlivreur.php?idl=<?PHP echo $row['idl']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
