		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-12 col-md-offset-0 text-center fh5co-heading">
					<h2><span>Votre Reclamation</span></h2>
				</div>
			</div>
		</div>
...
$listeReclamation=$reclamation1C->afficherReclmationsClient($_SESSION['l']);

//var_dump($listeEmployes->fetchAll());
?>		
          <form method="POST" action="supprimerReclamation.php" style="border: none">
        <div class="container">
<div class="row">
    <?PHP
...
<center>
    ...
    <div class="card">
      <div class="card-body">
        <h1 class="card-title">Client:<?PHP echo $row['idUtilisateurr']; ?></h1>
         <h3 class="card-title">Sujet:<?PHP echo $row['sujetReclamation']; ?></h3>
        <p class="card-text">Commentaire:<?PHP echo $row['commentaireReclamation']; ?></p>
       
        <p>In- <?PHP echo $row['date']; ?></p>
	<input type="submit" name="supprimer Votre reclamation" value="supprimer votre reclamation" class="btn btn-primary" >
	<input type="hidden" value="<?PHP echo $row['numReclamation']; ?>" name="numReclamation">
    
	</form>
    <a href="modifierReclamation.php?numReclamation=<?PHP echo $row['numReclamation']; ?>" class="btn btn-primary">Modifier votre reclamation</a>
      </div>
    </div>
