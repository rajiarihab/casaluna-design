...
if (isset($_GET['num'])){
    ...
    $result=$suggestionPC->recupererSuggestionP($_GET['num']);
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-12 col-md-offset-0 text-center fh5co-heading">
					<h2><span>Les Suggestions Particulieres</span></h2>
				</div>
			</div>
		</div>
		<center>
...
<tr>
<td><input type="text" name="date" value="<?PHP echo $date ?>" hidden></td>
</tr>
<tr>
<td>sujet</td>
...
<td><a href="suggestionP.php" class="btn btn-primary">Afficher</a></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
	$suggestionP=new suggestionP($_POST['num'],$_SESSION['l'],$_POST['date'],$_POST['sujet'],$_POST['commentaire']);
	$suggestionPC->modifierSuggestionP($suggestionP,$_POST['num_ini']);
